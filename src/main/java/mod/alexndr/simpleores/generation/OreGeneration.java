...
public class OreGeneration
{
    ...
    private static final CountRangeConfig tin_cfg = new CountRangeConfig(10, 20, 0, 72);
    private static final int tin_veinsize = 7;
    private static final CountRangeConfig mythril_cfg = new CountRangeConfig(8, 1, 0, 32);
    private static final int mythril_veinsize = 6;
    private static final CountRangeConfig adamantium_cfg = new CountRangeConfig(7, 1, 0, 24);
    private static final int adamantium_veinsize = 6;
    private static final CountRangeConfig onyx_cfg = new CountRangeConfig(6, 10, 0, 128);
